...
diabetes_model = load_model("C:\\Users\\Hp\\Downloads\\diabetes_model (3).pkl")
heart_disease_model = load_model("C:\\2k25\\AICTE Diseases Breakout\\heart_disease_model.pkl")
diabetes_scaler = load_model("C:\\Users\\Hp\\Downloads\\diabetes_scaler (3).pkl")  # Ensure scaler is saved
